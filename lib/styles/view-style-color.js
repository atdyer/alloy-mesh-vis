...
export default function view_style_color (styler) {
    ...
    function style_color_box (color) {
        ...
        select(this)
            ...
            .style('flex', '0 1 auto')
            .style('min-width', '1.21em')
            .style('min-height', '1.21em')
            .style('cursor', 'pointer')
            .style('background-color', color)
            .style('border', '1px solid ' + (t ? 'rgb(190,190,190)' : color));
    }
