...
import { property_dynamic, property_static } from "./alloy-property";
...
function extract_meshes (instance) {
    ...
    let mesh_atms = instance.signature(mesh_sig).atoms,
        mesh_elems = instance.relation(elem_rel, elem_rel_sig).table,
        elem_edges = instance.relation(edge_rel, edge_rel_sig).table;
